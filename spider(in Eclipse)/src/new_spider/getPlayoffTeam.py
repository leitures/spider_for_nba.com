...
#PLUS_MINUS CHAR(10)
        ...
        #使用cursor()方法获取操作游标
        cursor = db.cursor()
        sql = "INSERT INTO PLAYOFFTEAM(GAME_ID,TEAM_ID,TEAM_NAME,TEAM_ABBREVIATION,TEAM_CITY,MIN,FGM,FGA,FG_PCT,FG3M,FG3A,FG3_PCT,FTM,FTA,FT_PCT,OREB,DREB,REB,AST,STL,BLK,TOV,PF,PTS,PLUS_MINUS) VALUES ("+str1+")"
