...
#                player.append(a_tag.string)
    ...
    def savePageInfo(self,pageIndex):
        ...
        #pattern
        numOfQuarters = len(self.getSingleData(page, '<td class="number">'))
        #print numOfQuarters
        ...
        year_date = self.getSingleData(page, '<div style="float: left;margin-top: 25px;margin-left: 10px;font-size: 16px;font-weight: bold;color: #009CFF">(.*?) <font style')
